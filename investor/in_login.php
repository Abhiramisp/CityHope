...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="../../../../Users/DELL/Downloads/concept-master/concept-master/index.html"><img class="logo-img" src="../unnamed.png" alt="logo" width="100" height="50"></a><span class="splash-description"></span></div>
            <div class="card-body">
                <form action="inlog.php" method="post">
                    <div class="form-group">
                        <input class="form-control form-control-lg" id="username" name="uname" type="text" placeholder="Username" autocomplete="off">
                    </div>
                    <div class="form-group">
            ...
            <div class="card-footer bg-white p-0  ">
                <div class="card-footer-item card-footer-item-bordered">
                    <a href="in_registration.php" class="footer-link">Create An Account</a></div>
                <div class="card-footer-item card-footer-item-bordered">
